    ...
    <div style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          <div>
            <label style={{
              ...
              {/* Sử dụng font icon Material Symbols Outlined giống 9Router */}
              <span className="material-symbols-outlined" style={{ fontSize: "14px", color: "#e56a4a" }}>person</span>
              Tên đăng nhập
            </label>
            <input
               type="text"
          ...
          {isRegister && (
            <div>
              <label style={{
                ...
                <span className="material-symbols-outlined" style={{ fontSize: "14px", color: "#e56a4a" }}>mail</span>
                Địa chỉ Email
              </label>
              <input
                type="email"
          ...
          <div>
            <label style={{
              ...
              <span className="material-symbols-outlined" style={{ fontSize: "14px", color: "#e56a4a" }}>lock</span>
              Mật khẩu
            </label>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: "12px", marginBottom: "10px" }}>
          ...
          >
            {/* Google SVG Logo (giữ nguyên theSVG gốc theo yêu cầu) */}
          ...
          <button
            ...
            onMouseOut={(e) => e.currentTarget.style.backgroundColor = "#303030"}
          >
            {/* GitHub SVG Logo (giữ nguyên theSVG gốc theo yêu cầu) */}
